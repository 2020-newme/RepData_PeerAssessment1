...
```{r echo=TRUE}
hist(steps_by_date$steps, main = "Histogram of Steps Taken per Day", xlab = "total steps")
```

So, we see that the most recurring number of steps in a day was indeed a little a litlle over ten thousand.
